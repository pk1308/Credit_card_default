...
from CCdefault.app_entity.artifacts_entity import ModelPusherArtifact, DataIngestionArtifact, ModelEvaluationArtifact
from CCdefault.app_entity.artifacts_entity import DataValidationArtifact, DataTransformationArtifact, ModelTrainerArtifact
from CCdefault.app_entity.config_entity import DataIngestionConfig, ModelEvaluationConfig
from CCdefault.app_src.stage_00_data_ingestion import DataIngestion
from CCdefault.app_src.stage_01_data_validation import DataValidation
from CCdefault.app_src.stage_02_data_transformation import DataTransformation
from CCdefault.app_src.stage_03_model_trainer import ModelTrainer
from CCdefault.app_src.stage_04_model_evalution import ModelEvaluation
from CCdefault.app_src.stage_05_model_pusher import ModelPusher
import os, sys
from collections import namedtuple
from datetime import datetime
import pandas as pd
from CCdefault.app_constants import EXPERIMENT_DIR_NAME, EXPERIMENT_FILE_NAME
...
class Pipeline(Thread):
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        try:
            data_ingestion = DataIngestion(data_ingestion_config_info=self.config.get_data_ingestion_config())
